#!/usr/bin/env python3
"""
Build Table 6 (embedding UC/CAP classifiers) as HTML under manuscript/table6_embedding_uc_cap.html.
...
Run from the repository root: ``python helpers/table6_embedding_uc_cap.py``
"""
...
OUTPUT_REL = Path("manuscript") / "table6_embedding_uc_cap.html"
