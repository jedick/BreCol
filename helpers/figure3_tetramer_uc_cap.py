...
Run from the repository root: ``python helpers/figure3_tetramer_uc_cap.py``
"""
...
OUTPUT_PNG = Path("manuscript") / "figure3_tetramer_uc_cap.png"
OUTPUT_SVG = Path("manuscript") / "figure3_tetramer_uc_cap.svg"
