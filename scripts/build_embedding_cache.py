...
def _batch_token_ids(
    ...
    if not token_rows:
        raise ValueError("_batch_token_ids requires at least one sequence")
...
def embeddings_from_sequences(
    ...
    *,
    ...
    for start in range(0, n, batch_size):
        ...
        input_ids, attention_mask = _batch_token_ids(token_rows)
        ...
        reduced = _reduce_hidden_states(hidden, attention_mask, mode=sequence_reduce)
